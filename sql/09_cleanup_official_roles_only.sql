...
-- 3. Mettre à jour les intitulés officiels stricts des 9 rôles (+ SuperAdmin)
UPDATE roles SET name = '👑 SuperAdministrateur — Coordination Générale', description = 'Accès global, supervision des 9 pôles, gestion des comptes et finances' WHERE code = 'superadmin';
UPDATE roles SET name = '📢 Responsable — Communication & Affichage', description = 'Pôle 1 : Affiches, flyers, réseaux sociaux, WhatsApp, signalétique, plan kermesse' WHERE code = 'admin_communication';
UPDATE roles SET name = '🎟️ Responsable — Billetterie / Tickets / Caisse / Comptabilité', description = 'Pôle 2 : Tickets entrée/jeux/lots/préventes, séries, caisses centrale & stands, écarts' WHERE code = 'admin_finances';
UPDATE roles SET name = '🎨 Responsable — Organisation & Décoration', description = 'Pôle 3 : Ambiance festive, matériel déco, aménagement des zones et plan d''implantation' WHERE code = 'admin_decoration';
UPDATE roles SET name = '🍔 Responsable — Restauration', description = 'Pôle 4 : Cuisine, boissons, snacks, stocks denrées, hygiène et ventes buvette' WHERE code = 'admin_restauration';
UPDATE roles SET name = '🎪 Responsable — Stands & Jeux', description = 'Pôle 5 : Gestion des stands (Couleur+N°), catalogue jeux, règles, prix tickets, équipes stands' WHERE code = 'admin_stands';
UPDATE roles SET name = '🎁 Responsable — Lots à gagner', description = 'Pôle 6 : Catalogue des lots (achats & dons), dotations stands et suivi des distributions' WHERE code = 'admin_lots';
UPDATE roles SET name = '👥 Responsable — Planning & Bénévoles', description = 'Pôle 7 : Fiches bénévoles, contacts WhatsApp, planning créneaux et anti-conflits' WHERE code = 'admin_benevoles';
UPDATE roles SET name = '📦 Responsable — Logistique & Installation', description = 'Pôle 8 : Matériel lourd (tentes, tables, sono, électricité), chaîne de prêt et checklists' WHERE code = 'admin_logistique';
UPDATE roles SET name = '🛡️ Responsable — Accueil & Sécurité', description = 'Pôle 9 : Accueil, objets trouvés, rondes sanitaires, urgences et registre incidents' WHERE code = 'admin_securite';
